...
export const ABOUT = {
  ...
  ABOUT:
    "A Software Developer 🪄 having an experience of building Web Applications with JavaScript / TypeScipt / Reactjs / Nodejs and some other cool libraries and frameworks.",
};
...
export const BUTTONTWO = {
  TYPE: "SEE MY RESUME",
  LINK: "https://drive.google.com/file/d/16danvyvFBBvUvTO88mIOHKjf9x-NAAF2/view?usp=share_link",
};
