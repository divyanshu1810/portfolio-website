...
export const ABOUT = {
    ...
    ABOUT: "A Software Developer 🪄 having an experience of building Web Applications with JavaScript / TypeScipt / Reactjs / Nodejs and some other cool libraries and frameworks.",
};
